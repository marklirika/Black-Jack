...
Q_CONSTINIT static const qt_meta_stringdata_Menu_t qt_meta_stringdata_Menu = {
    {
        ...
        QT_MOC_LITERAL(5, 18),  // "soundButtonClicked"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 17),  // "faceButtonClicked"
        QT_MOC_LITERAL(43, 18),  // "shirtButtonClicked"
        QT_MOC_LITERAL(62, 17)   // "backButtonClicked"
    },
    "Menu",
    "soundButtonClicked",
    "",
...
void Menu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Menu::*)();
            if (_t _q_method = &Menu::soundButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Menu::*)();
            if (_t _q_method = &Menu::faceButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Menu::*)();
            if (_t _q_method = &Menu::shirtButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Menu::*)();
            if (_t _q_method = &Menu::backButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void Menu::soundButtonClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Menu::faceButtonClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Menu::shirtButtonClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void Menu::backButtonClicked()
{
